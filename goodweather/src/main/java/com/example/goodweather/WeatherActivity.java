...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forecaseLayout=(LinearLayout)findViewById(R.id.forcase_layout);
    ...
    private void loadBingPic() {
        ...
        UtilHttp.sendOkHttpRequest(requestBingPic, new Callback() {
            @Override
    ...
    public void requestWeather(String weatherId) {
        String weatherUrl="http://guolin.tech/api/weather?cityid="+weatherId+"&key=24de29dff2bb43d5811f428abf311362";
        UtilHttp.sendOkHttpRequest(weatherUrl, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
